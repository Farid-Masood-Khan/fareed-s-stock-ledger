...
const ExpensesPage = () => {
  ...
  const { isMoneyHidden } = useSettings();
  ...
  const filteredExpenses = expenses.filter(expense => {
    const matchesTerm = expense.description.toLowerCase().includes(searchTerm.toLowerCase()) || 
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="border rounded-md">
              ...
              <div className="divide-y">
                {sortedExpenses.length === 0 ? (
                  ...
                  sortedExpenses.map((expense) => (
                    <div key={expense.id} className="grid grid-cols-[1fr,auto,auto,auto] sm:grid-cols-[1fr,1fr,auto,auto,auto] items-center px-4 py-3 hover:bg-muted/50">
              ...
              {sortedExpenses.length > 0 && (
                <div className="px-4 py-3 flex justify-end border-t bg-muted/40">
